...
use crate::export::x_data::x_style::{XTextStyle, XAlignEnum};
...
impl XImageGen {
    #[wasm_bindgen]
    pub fn combine2(x: &XCore, format: XImageFormatEnum, bg_color: &XColor, align_x: XAlignEnum, align_y: XAlignEnum, i1: &XImage, i2: &XImage) -> Option<XImage> {
    ...
    #[wasm_bindgen]
    pub fn color(x: &XCore, format: XImageFormatEnum, color: &XColor, width: u32, height: u32) -> Option<XImage> {
    ...
    #[wasm_bindgen]
    pub fn text(x: &XCore, format: XImageFormatEnum, color: &XColor, width: u32, height: u32, text_style: &XTextStyle, text: String) -> Option<XImage> {
        let color = [color.r, color.g, color.b, color.a];
